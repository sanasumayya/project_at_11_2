...
class Test_Sana:
    ...
    def test_Login(self, booting_function):
       ...
       sleep(10)
    #    self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators().activation_button).click()
       source=self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators().activation_button)
       action = ActionChains(self.driver)
       action.click(source).perform()
       sleep(10)
