...
class Test_Sana:
    ...
    def test_Login(self, booting_function):
       ...
       action.click(source).perform()
       sleep(5)
       source=self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators.tax_exemption)
       action = ActionChains(self.driver)
       sleep(2) 
       action.click(source).perform()
       sleep(5)
       self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators().status).click()
       self.driver.find_element(by=By.XPATH, value="//div[@role='listbox']").click()
       sleep(2)
       self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators.exemptions).send_keys('12')
       sleep(5)
       self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators().tax_state).click()
       self.driver.find_element(by=By.XPATH, value="//div[@role='listbox']").click()
       sleep(2)
       self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators().status2).click()
       self.driver.find_element(by=By.XPATH, value="//div[@role='listbox']").click()
       sleep(2)
       self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators.exemptions_2).send_keys('23')
       sleep(2)
       self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators().unemployment_state).click()
       self.driver.find_element(by=By.XPATH, value="//div[@role='listbox']").click()
       sleep(2)
       self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators().work_state).click()
       self.driver.find_element(by=By.XPATH, value="//div[@role='listbox']").click()
       sleep(2)
       self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators().tax_savebutton).click()
       sleep(10)
