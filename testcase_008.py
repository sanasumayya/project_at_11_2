...
class Test_Sana:
    ...
    def test_Login(self, booting_function):
       ...
       source=self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators.dependents)
       action = ActionChains(self.driver)
       action.click(source).perform()
       sleep(5)

       source=self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators.dependents_addbutton)
       action = ActionChains(self.driver)
       action.click(source).perform()
       sleep(5)

       input_box = self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators.dependent_name)
       input_box.clear()
       input_box.send_keys(data2.Sana2_Data.dependent_name_inputbox)
       sleep(5)
       ...
       self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators().calender).send_keys(data2.Sana2_Data.calender_inputbox)
       sleep(5)
       self.driver.find_element(by=By.XPATH, value=locators2.Sana2_Locators().dependents_savebutton).click()
       sleep(15)
